...
public class Snakes extends Animal {
     ...
     * protect it from being modified and therefore secure it even further. The
     * final amount is also put at 20 due to the reason that the amount of food
     * is not dependant on the weight og the animal and would only be subject to
     * change if HealthyPets where to change animal food.
     */
